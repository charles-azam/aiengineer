...
def print_config_summary():
    ...
    print(f"Core Dimensions: {SMR_CONFIG['core_height']}m × {SMR_CONFIG['core_diameter']}m (H×D)")
    print(f"Primary Loop: {SMR_CONFIG['primary_pressure']} MPa, "
          f"{SMR_CONFIG['primary_temp_inlet']}°C to {SMR_CONFIG['primary_temp_outlet']}°C")
    print(f"Secondary Loop: {SMR_CONFIG['secondary_pressure']} MPa, "
