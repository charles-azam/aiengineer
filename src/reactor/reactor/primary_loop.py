...
class PrimaryLoop:
    ...
    def display_info(self):
        ...
        print(f"Temperature Range: {self.inlet_temp}°C to {self.outlet_temp}°C (ΔT: {self.delta_t}°C)")
        ...
        print("Manufacturing: Factory-assembled modules with field welding of major connections")
...
def calculate_safety_parameters():
    ...
    print(f"Emergency Cooling Capacity: {safety_params['emergency_cooling_capacity']} MW")
