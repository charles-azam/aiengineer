...
class ReactorCore:
    ...
    """
    def __init__(self, thermal_power, core_height, core_diameter, 
                 fuel_type, enrichment, fuel_assemblies):
        """
    ...
    def display_info(self):
        ...
        print("Materials: Zirconium alloy fuel cladding, 316L stainless steel structures")
...
def calculate_reactivity_coefficients():
    ...
    print(f"Moderator Temperature Coefficient: {coefficients['moderator_temperature']} pcm/°C")
